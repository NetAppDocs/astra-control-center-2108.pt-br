...
image:astra-cc-arch2.png["Diagrama e componentes da arquitetura Astra Control"]
...
* * Storage backend*: O Astra Control Service usa https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service para Google Cloud"^] como armazenamento de back-end para clusters GKE e https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Files"^] como armazenamento de back-end para clusters AKS.
+
...
* https://docs.netapp.com/us-en/astra-control-center/index.html["Documentação do Astra Control Control Control"^]
